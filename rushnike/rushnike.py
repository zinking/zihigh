...
def get_required_cookie( ):
    required_ck1['AnalysisUserId'] = '210.192.109.15.42871429458355777'
...
def purchase_scenario():
    ...
    c1 = load_cookies_from_file('/Users/awang/Downloads/rushnike/hcookies.txt')
    print '*************add to cart by jsonp'
    cUrl1 = 'https://secure-store.nike.com/ap/services/jcartService?callback=nike_Cart_handleJCartResponse&action=addItem&lang_locale=zh_CN&country=CN&catalogId=4&productId=10264996&price=839&siteId=null&line1=Air+Jordan+Future+Low&line2=%E7%94%B7%E5%AD%A9%E8%BF%90%E5%8A%A8%E7%AB%A5%E9%9E%8B&passcode=null&sizeType=null&skuAndSize=11565092%3A39&qty=1&rt=json&view=3&skuId=11565092&displaySize=39'
    checkOutCartUrl = cUrl1 + '&_='+str(ts())
    print 'jsonp checkOutCart:',checkOutCartUrl
    r25 = nikeSession.get(checkOutCartUrl,cookies=c1)
    debug_ajax_response(r25)

    #u1 = r25.cookies['AnalysisUserId']
    u1 = '210.192.109.14.43221429627722844'
